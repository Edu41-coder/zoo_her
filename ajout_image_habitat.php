...
<body>
    ...
    ?>
    <div class="container">
        <h1>Ajouter une image pour l'habitat <?php echo $_GET['nom'] ?></h1>
        <form action="ajout-image-habitat.php" method="post" enctype="multipart/form-data">
        ...
        <button class="btn btn-primary mt10perso"><a class="lien" href="detail_habitat.php?id=<?php echo $_GET['id'];?>">Retour sur la fiche de l'habitat</a></button>
    </form>
    </div>
    <?php
        include("footer.php");
